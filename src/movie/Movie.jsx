        ...
        <>
            {loader ? (<MovieSkeleton />)
                : (<ScrollView>
                    ...
                    <StyledTouchableOpacity onPress={() => { nav.goBack() }} className='absolute rounded-full items-center justify-center top-[30px] ml-5 z-10 bg-[#1F1D36] w-[40px] h-[40px] shadow-xl shadow-black'>
                    ...
                    <StyledView className='flex-row justify-between  px-5'>
                        <StyledView className='-top-16'>
                            <FastImage className="w-[120px] rounded-lg shadow-black shadow-2xl h-[190px]"
                                source={{
                                    uri: `https://image.tmdb.org/t/p/w500${data?.posterPath}`,
                                    priority: FastImage.priority.normal,
                                }}
